...
<!-- Version: $Id: diffspec.xsl,v 1.1 2009/12/01 15:41:45 ht Exp $ --><!-- Stylesheet for @diff markup in XMLspec --><!-- Author: Norman Walsh (Norman.Walsh@East.Sun.COM) --><!-- Date Created: 2000.07.21 --><!-- This stylesheet is copyright (c) 2000 by its authors.  Free
...
<xsl:import href="xml-names-shadow.xsl"/>
...
<xsl:template name="diff-markup">
  ...
  <xsl:choose>
    <xsl:when test="ancestor-or-self::phrase or self::xnt or self::nt">
